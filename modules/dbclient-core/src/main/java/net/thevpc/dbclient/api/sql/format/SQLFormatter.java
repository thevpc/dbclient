...
package net.thevpc.dbclient.api.sql.format;
 ...
 * @creationtime 27 juil. 2006 14:53:04
 */
@Extension(group = "sql")
public interface SQLFormatter extends DBCPluggable {
    public void setParser(SQLParser parser);

    public String formatToken(SQLToken token);

    public String formatStatement(SQLStatement stmt);

    public String formatDocument(String stmt);
}
