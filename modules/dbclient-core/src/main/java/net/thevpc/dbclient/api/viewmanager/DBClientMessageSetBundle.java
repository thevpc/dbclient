...
import net.thevpc.common.prs.messageset.MessageSetBundleAdapter;

/**
 * @author Taha Ben Salah (taha.bensalah@gmail.com)
 * @creationtime 28 avr. 2007 21:09:04
 */
public class DBClientMessageSetBundle extends MessageSetBundleAdapter {
    private DBCPlugin plugin;

    public DBClientMessageSetBundle(DBCPlugin plugin) {
        this.plugin = plugin;
    }
