...
import net.thevpc.common.swing.util.jcmd.*;
import net.thevpc.dbclient.api.DBCApplication;
import net.thevpc.dbclient.api.DBCApplicationImpl;
import net.thevpc.dbclient.api.DBClientInfo;
import net.thevpc.dbclient.api.configmanager.DBCLockedConfigException;
import net.thevpc.dbclient.api.configmanager.DBCShouldRestartException;
import net.thevpc.dbclient.api.viewmanager.DBCSplashScreen;
//import net.thevpc.jcmd.*;
//import net.thevpc.common.swing.dialog.MessageDialogType;
//import net.thevpc.util.Chronometer;
//import net.thevpc.util.ProgressMonitor;
...
//import net.thevpc.common.prs.log.SimpleLogFormatter;
//import net.thevpc.common.swing.SwingUtilities3;
//import net.thevpc.util.CancelException;
...
public class DBClientMain {
    ...
    public static void mainUnsafe(final String[] args) {
        ...
        try {
            ...
            d.getLogger(DBClientMain.class.getName()).log(Level.INFO, "[PERF] APPLICATION STARTUP IN " + Chronometer.formatPeriodFixed(System.currentTimeMillis() - startupTime, DatePart.ms, DatePart.s));
