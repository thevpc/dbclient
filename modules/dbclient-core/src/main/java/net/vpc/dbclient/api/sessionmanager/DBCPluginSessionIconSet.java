...
import net.vpc.prs.iconset.IconSetAdapter;

/**
 * @author Taha Ben Salah (taha.bensalah@gmail.com)
 * @creationtime 28 avr. 2007 20:43:31
 */
public class DBCPluginSessionIconSet extends IconSetAdapter {
    private DBCPluginSession plugin;

    public DBCPluginSessionIconSet(DBCPluginSession session) {
        super();
        this.plugin = session;
        setIdPrefix("DBCPluginSessionIconSet:" + session.getPlugin().getId());
    }
