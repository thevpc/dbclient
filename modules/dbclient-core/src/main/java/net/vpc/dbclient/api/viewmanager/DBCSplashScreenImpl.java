 ...
 */
public class DBCSplashScreenImpl extends SimpleSplashScreen implements DBCSplashScreen {
    ...
    public void addDefaultMessages() {
        ...
        if (messageSet == null) {
            addMessage(new SimpleSplashScreen.Message(SimpleSplashScreen.Type.INFO, "Version " + info.getProductVersion()));
            addMessage(new SimpleSplashScreen.Message(SimpleSplashScreen.Type.INFO, "Built on " + info.getProductBuildDate()));
            if (application != null) {
                int c = application.getPluginManager().getAllPlugins().length;
                addMessage(new SimpleSplashScreen.Message(SimpleSplashScreen.Type.INFO, "Plugins count " + c));
                ...
                addMessage(new SimpleSplashScreen.Message(SimpleSplashScreen.Type.INFO, "Work dir " + rfs));
                ...
                if (!ifolder.equals(rf)) {
                    ...
                    addMessage(new SimpleSplashScreen.Message(SimpleSplashScreen.Type.INFO, "Install dir " + rfs));
                }
            }
            addMessage(new SimpleSplashScreen.Message(SimpleSplashScreen.Type.INFO, "Java Version " + System.getProperty("java.version")));
            addMessage(new SimpleSplashScreen.Message(SimpleSplashScreen.Type.INFO, "Java Vendor " + System.getProperty("java.vendor")));
        } else {
            addMessage(new SimpleSplashScreen.Message(SimpleSplashScreen.Type.INFO, messageSet.get("Version") + " " + info.getProductVersion()));
            addMessage(new SimpleSplashScreen.Message(SimpleSplashScreen.Type.INFO, messageSet.get("About.BuildDate") + " " + info.getProductBuildDate()));
            if (application != null) {
                int c = application.getPluginManager().getAllPlugins().length;
                addMessage(new SimpleSplashScreen.Message(SimpleSplashScreen.Type.INFO, messageSet.get("About.PluginsCount",new Object[]{c})));
                File rf = application.getWorkingDir();
                String rfs = rf.getAbsolutePath();
                try {
                    rfs = rf.getCanonicalPath();
                ...
                addMessage(new SimpleSplashScreen.Message(SimpleSplashScreen.Type.INFO, messageSet.get("About.WorkDir") + " " + rfs));
                ...
                if (!irf.equals(rf)) {
                    ...
                    addMessage(new SimpleSplashScreen.Message(SimpleSplashScreen.Type.INFO, messageSet.get("About.InstallDir") + " " + rfs));
                }
            }
            addMessage(new SimpleSplashScreen.Message(SimpleSplashScreen.Type.INFO, messageSet.get("About.JavaVersion") + " " + System.getProperty("java.version")));
            addMessage(new SimpleSplashScreen.Message(SimpleSplashScreen.Type.INFO, messageSet.get("About.JavaVendor") + " " + System.getProperty("java.vendor")));
        }
    }
