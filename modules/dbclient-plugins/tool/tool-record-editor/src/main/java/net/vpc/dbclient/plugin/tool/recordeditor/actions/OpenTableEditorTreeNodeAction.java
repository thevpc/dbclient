...
public class OpenTableEditorTreeNodeAction extends DBCTreeNodeAction {

    public OpenTableEditorTreeNodeAction() {
        super("Action.OpenTableEditorNodeAction");
    ...
    public void actionPerformedImpl(ActionEvent e) throws Throwable {
        TableView defaultTableView = ((RecordEditorPluginSession)getPluginSession()).createTableView(getSession(), (DBTable) getSelectedNode());
