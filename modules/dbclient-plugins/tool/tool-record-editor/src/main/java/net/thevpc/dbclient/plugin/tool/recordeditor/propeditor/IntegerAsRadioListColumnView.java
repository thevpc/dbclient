 ...
 */
public class IntegerAsRadioListColumnView extends RadioListColumnView {
    public IntegerAsRadioListColumnView() {
        super(new IntegerColumnView());
    }


    protected Object configFromString(String o) {
        return (o == null || o.length() == 0) ? null : Integer.parseInt(o);
    }

    protected void fillDefaultData() {
        for (int i = 0; i < 3; i++) {
            getData().put((i + 1), "value " + (i + 1));
        }
    }
}
