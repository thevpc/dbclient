...
import net.thevpc.dbclient.plugin.tool.recordeditor.propeditor.*;
 ...
 */
@PluginInfo(
    messageSet = "net.thevpc.dbclient.plugin.tool.recordeditor.messageset.Plugin",
    iconSet = "net.thevpc.dbclient.plugin.tool.recordeditor.iconset.Plugin"
)
