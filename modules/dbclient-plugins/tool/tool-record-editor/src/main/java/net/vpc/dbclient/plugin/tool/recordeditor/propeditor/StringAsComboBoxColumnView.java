 ...
 */
public class StringAsComboBoxColumnView extends ComboBoxColumnView {
    public StringAsComboBoxColumnView() {
        super(new StringColumnView());
    }
    ...
    protected void fillDefaultData() {
        for (int i = 0; i < 3; i++) {
            getData().put("value " + (i + 1), "value " + (i + 1));
        }
    }
}
