...
package net.vpc.dbclient.plugin.tool.neormf;
 ...
 */
@PluginInfo(
        messageSet = "net.vpc.dbclient.plugin.tool.neormf.messageset.Plugin",
        iconSet = "net.vpc.dbclient.plugin.tool.neormf.iconset.Plugin"
)
public class NeormfPlugin extends DBCAbstractPlugin {
    ...
    public void updateLibFolder() {
        ...
        File r0 = IOUtils.canonize(new File(rootFolder + "/misc-lib/neormf"));
