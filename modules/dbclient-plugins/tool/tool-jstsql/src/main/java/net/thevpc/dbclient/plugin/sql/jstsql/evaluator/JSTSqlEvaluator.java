...
//                    lastNonWhiteToken = token.getType();
    ...
    private void writeHeader(Writer fos, String className, JSTSqlEvalContext context) throws IOException {
        fos.write("import net.thevpc.dbclient.api.sessionmanager.*;\n");
        fos.write("import net.thevpc.dbclient.api.sql.*;\n");
        fos.write("import net.thevpc.dbclient.api.sql.objects.*;\n");
        fos.write("import net.thevpc.dbclient.plugin.sql.jstsql.*;\n");
        fos.write("import net.thevpc.dbclient.plugin.sql.jstsql.evaluator.*;\n");
