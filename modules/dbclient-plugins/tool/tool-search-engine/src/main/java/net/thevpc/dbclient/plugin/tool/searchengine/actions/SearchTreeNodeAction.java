...
package net.thevpc.dbclient.plugin.tool.searchengine.actions;
...
import net.thevpc.dbclient.plugin.tool.searchengine.SearchEnginePluginSession;
import net.thevpc.dbclient.plugin.tool.searchengine.SearchPanel;
