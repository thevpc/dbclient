 ...
 */
@PluginInfo(
        messageSet = "net.thevpc.dbclient.plugin.tool.importexport.messageset.Plugin",
        iconSet = "net.thevpc.dbclient.plugin.tool.importexport.iconset.Plugin"
)
public class ImportExportPlugin extends DBCAbstractPlugin {
