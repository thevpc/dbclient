 ...
 */
public class TCnxPropertyFilter {
    ...
    public TCnxPropertyFilter setString(int pos, String value) {
    ...
    public TCnxPropertyFilter setDouble(int pos, double value) {
        SqlParam p = new SqlParam();
        p.setPos(pos);
        p.setValue(value);
    ...
    public TCnxPropertyFilter setInt(int pos, int value) {
        SqlParam p = new SqlParam();
        p.setPos(pos);
        p.setValue(value);
    ...
    public TCnxPropertyFilter setBoolean(int pos, boolean value) {
        SqlParam p = new SqlParam();
        p.setPos(pos);
        p.setValue(value);
    ...
    public TCnxPropertyFilter setFloat(int pos, float value) {
        SqlParam p = new SqlParam();
        p.setPos(pos);
        p.setValue(value);
    ...
    public TCnxPropertyFilter setDate(int pos, java.sql.Date value) {
        SqlParam p = new SqlParam();
        p.setPos(pos);
        p.setValue(value);
    ...
    public TCnxPropertyFilter setTime(int pos, java.sql.Time value) {
        SqlParam p = new SqlParam();
        p.setPos(pos);
        p.setValue(value);
    ...
    public TCnxPropertyFilter setTimestamp(int pos, java.sql.Timestamp value) {
        SqlParam p = new SqlParam();
        p.setPos(pos);
        p.setValue(value);
    ...
    public TCnxPropertyFilter setLong(int pos, long value) {
        SqlParam p = new SqlParam();
        p.setPos(pos);
        p.setValue(value);
    ...
    public TCnxPropertyFilter merge(TCnxPropertyFilter other) {
        if (other == null) {
            return this;
        }
        TCnxPropertyFilter newCriteria = new TCnxPropertyFilter();
    ...
    public TCnxPropertyFilter orderBy(String orderColumn, boolean asc) {
        orderFields.add(orderColumn);
        orderAsc.add(asc ? Boolean.TRUE : Boolean.FALSE);
        return this;
    }

    public TCnxPropertyFilter orderByCprName(boolean asc) {
        orderBy(TCnxPropertyPropertyList.CPR_NAME, asc);
        return this;
    }

    public TCnxPropertyFilter orderByCprSesId(boolean asc) {
        orderBy(TCnxPropertyPropertyList.CPR_SES_ID, asc);
        return this;
    }

    public TCnxPropertyFilter orderByCprValue(boolean asc) {
        orderBy(TCnxPropertyPropertyList.CPR_VALUE, asc);
        return this;
    }

    public TCnxPropertyFilter setAll(TCnxPropertyDTO prototype) throws SQLException {
        // building criteria
            ...
            for (Iterator i = prototype.keySet().iterator(); i.hasNext();) {
                ...
                switch (selectedFieldId) {
                    case -587396585: {  //column CPR_VALUE
                        ...
                        java.lang.String columnValue = prototype.getCprValue();
                        whereClause.append("T_CNX_PROPERTY.CPR_VALUE = ?");
                    ...
                    case 404225719: {  //field cprSesId
                        ...
                        int columnValue = prototype.getCprSesId();
                        whereClause.append("T_CNX_PROPERTY.CPR_SES_ID = ?");
                    ...
                    case 1227739397: {  //column CPR_NAME
                        ...
                        java.lang.String columnValue = prototype.getCprName();
                        whereClause.append("T_CNX_PROPERTY.CPR_NAME = ?");
                        setString(pos++, columnValue);
                        break;
        ...
        // START object-definition.do<name=TCnxProperty>.userCode.findAll
        // code retreived from object-definition.do<name=TCnxProperty>.userCode.findAll
        // END   object-definition.do<name=TCnxProperty>.userCode.findAll
