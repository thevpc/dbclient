 ...
 */
public class TUiNodePropertyFilter {
    ...
    public TUiNodePropertyFilter setString(int pos, String value) {
    ...
    public TUiNodePropertyFilter setDouble(int pos, double value) {
        SqlParam p = new SqlParam();
        p.setPos(pos);
        p.setValue(value);
    ...
    public TUiNodePropertyFilter setInt(int pos, int value) {
        SqlParam p = new SqlParam();
        p.setPos(pos);
        p.setValue(value);
    ...
    public TUiNodePropertyFilter setBoolean(int pos, boolean value) {
        SqlParam p = new SqlParam();
        p.setPos(pos);
        p.setValue(value);
    ...
    public TUiNodePropertyFilter setFloat(int pos, float value) {
        SqlParam p = new SqlParam();
        p.setPos(pos);
        p.setValue(value);
    ...
    public TUiNodePropertyFilter setDate(int pos, java.sql.Date value) {
        SqlParam p = new SqlParam();
        p.setPos(pos);
        p.setValue(value);
    ...
    public TUiNodePropertyFilter setTime(int pos, java.sql.Time value) {
        SqlParam p = new SqlParam();
        p.setPos(pos);
        p.setValue(value);
    ...
    public TUiNodePropertyFilter setTimestamp(int pos, java.sql.Timestamp value) {
        SqlParam p = new SqlParam();
        p.setPos(pos);
        p.setValue(value);
    ...
    public TUiNodePropertyFilter setLong(int pos, long value) {
        SqlParam p = new SqlParam();
        p.setPos(pos);
        p.setValue(value);
    ...
    public TUiNodePropertyFilter merge(TUiNodePropertyFilter other) {
        if (other == null) {
            return this;
        }
        TUiNodePropertyFilter newCriteria = new TUiNodePropertyFilter();
    ...
    public TUiNodePropertyFilter orderBy(String orderColumn, boolean asc) {
        orderFields.add(orderColumn);
        orderAsc.add(asc ? Boolean.TRUE : Boolean.FALSE);
        return this;
    }

    public TUiNodePropertyFilter orderByUnpCode(boolean asc) {
        orderBy(TUiNodePropertyPropertyList.UNP_CODE, asc);
        return this;
    }

    public TUiNodePropertyFilter orderByUnpPath(boolean asc) {
        orderBy(TUiNodePropertyPropertyList.UNP_PATH, asc);
        return this;
    }

    public TUiNodePropertyFilter orderByUnpSesId(boolean asc) {
        orderBy(TUiNodePropertyPropertyList.UNP_SES_ID, asc);
        return this;
    }

    public TUiNodePropertyFilter orderByUnpValue(boolean asc) {
        orderBy(TUiNodePropertyPropertyList.UNP_VALUE, asc);
        return this;
    }

    public TUiNodePropertyFilter setAll(TUiNodePropertyDTO prototype) throws SQLException {
        // building criteria
            ...
            for (Iterator i = prototype.keySet().iterator(); i.hasNext();) {
                ...
                switch (selectedFieldId) {
                    case 701348493: {  //column UNP_PATH
                        ...
                        java.lang.String columnValue = prototype.getUnpPath();
                        whereClause.append("T_UI_NODE_PROPERTY.UNP_PATH = ?");
                    ...
                    case -224387519: {  //column UNP_SES_ID
                        ...
                        int columnValue = prototype.getUnpSesId();
                        whereClause.append("T_UI_NODE_PROPERTY.UNP_SES_ID = ?");
                    ...
                    case -119578950: {  //field unpValue
                        ...
                        java.lang.String columnValue = prototype.getUnpValue();
                        whereClause.append("T_UI_NODE_PROPERTY.UNP_VALUE = ?");
                        setString(pos++, columnValue);
                        break;
                    ...
                    case -281504892: {  //field unpCode
                        ...
                        java.lang.String columnValue = prototype.getUnpCode();
                        whereClause.append("T_UI_NODE_PROPERTY.UNP_CODE = ?");
                        setString(pos++, columnValue);
                        break;
        ...
        // START object-definition.do<name=TUiNodeProperty>.userCode.findAll
        // code retreived from object-definition.do<name=TUiNodeProperty>.userCode.findAll
        // END   object-definition.do<name=TUiNodeProperty>.userCode.findAll
