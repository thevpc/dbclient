package net.thevpc.dbclient.plugin.dbsupport.postgresql.features;
 ...
 */
public class PostgreSqlGenerateSQLRenameFeature implements GenerateSQLRenameFeature {
    ...
    public String getSQL(String catalog, String schema, String parentName, String objectName, String newName, SQLObjectTypes objectType) throws SQLException {
        switch (objectType) {
            ...
            case TABLE_COLUMN: {
                return "ALTER TABLE " + SystemSQLUtils.getFullName(catalog, schema, null, parentName, SQLObjectTypes.TABLE) + " RENAME COLUMN " + objectName + " TO " + newName;
            }
        }
        return null;
    }
