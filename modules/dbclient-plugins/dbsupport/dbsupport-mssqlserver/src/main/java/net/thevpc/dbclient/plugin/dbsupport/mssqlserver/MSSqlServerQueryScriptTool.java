...
//
//import net.thevpc.dbclient.api.sql.BatchProcessorListener;
//import net.thevpc.dbclient.session.window.sqleditor.SQLCommandPane;
//import net.thevpc.dbclient.session.window.sqleditor.tool.SQLQueryTool;
//import net.thevpc.dbclient.api.session.actions.AsynchActionListener;
//import net.thevpc.common.prs.PRSManager;
//import net.thevpc.util.TLog;
//
///**
