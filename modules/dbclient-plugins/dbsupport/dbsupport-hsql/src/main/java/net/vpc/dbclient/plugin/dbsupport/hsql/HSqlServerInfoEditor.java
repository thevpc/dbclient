 ...
 */
public class HSqlServerInfoEditor extends JPanel implements DBCServerInfoEditor {
    ...
    public void init(DBCServerManagerHandler managerHandler) {
        ...
        add(dbNameText, "dbNameText");
        add(dbNameLabel, "dbNameLabel");
        add(portText, "portText");
    ...
    public DBCServerInfo showDialog(Component parent, DBCServerInfo value) {
        HSqlServerInfo vvalue = (HSqlServerInfo) value;
        if (vvalue == null) {
            vvalue = (HSqlServerInfo) managerHandler.createServerInfo();
            vvalue.setConfigName(HSqlServerManager.TYPE);
            vvalue.setClassPathType(HSqlClassPathType.PLUGIN);
        ...
        dbNameLabel.setText("Instance Name");
        serverLabel.setText("HSql Server Libraries");
        serverFolder.setText("From Lib Folder");
        serverPlugin.setText("From Plugin");
        serverFolderLocation.setText(vvalue.getLibFolderPath());
        HSqlClassPathType type = vvalue.getClassPathType();
        serverFolder.setSelected(HSqlClassPathType.FOLDER.equals(type));
        serverPlugin.setSelected(HSqlClassPathType.PLUGIN.equals(type));
        serverFolderLocation.setEnabled(serverFolder.isSelected());
        ...
        dbNameText.setText(vvalue.getDBName());
    ...
    private DBCServerInfo getDBServerInfo() {
        ...
        info.setClassPathType(serverFolder.isSelected() ? HSqlClassPathType.FOLDER : HSqlClassPathType.PLUGIN);
