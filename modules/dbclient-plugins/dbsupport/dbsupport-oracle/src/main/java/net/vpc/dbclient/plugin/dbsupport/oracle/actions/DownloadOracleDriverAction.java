...
import net.vpc.swingext.html.HtmlComponent;
import net.vpc.swingext.html.HtmlComponentsCollection;
...
//        p.add(acceptLicence,BorderLayout.SOUTH);
    ...
    public boolean isLocallyAvailable(DriverURLInfo u) throws IOException {
        ...
        for (URL url : u.getUrls()) {
            String name = IOUtils.getURLName(url);
            if (name.isEmpty()) {
                name = IOUtils.getNameWithExtension("" + index, "jar");
            }
