...
//
//public class ListTablePrivilegesTreeNodeAction extends DBCTreeNodeAction {
//    public ListTablePrivilegesTreeNodeAction() {
//        super("Action.ListTablePrivilegesTreeNodeAction");
//        addLocationPath(DBCActionLocation.POPUP, "/List");
//    }
//
//    public boolean shouldEnable(DBObject activeNode, DBObject[] selectedNodes) {
//        return (activeNode != null && SystemSQLUtils.isTableColumnUp(activeNode));
//    }
//
