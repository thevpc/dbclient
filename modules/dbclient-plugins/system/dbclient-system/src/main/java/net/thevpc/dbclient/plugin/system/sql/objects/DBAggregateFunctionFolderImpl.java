...
import net.thevpc.dbclient.api.sql.objects.DBAggregateFunctionFolder;
 ...
 */
public class DBAggregateFunctionFolderImpl extends DBAbstractFunctionFolderImpl implements DBAggregateFunctionFolder {
    public void init(DBCConnection session) {
        super.init(session, "AggregateFunctions");
    }


    @Override
    protected void loadChildren() throws SQLException {
        DBFunction[] fcts = getConnection().getAggregateFunctions();
