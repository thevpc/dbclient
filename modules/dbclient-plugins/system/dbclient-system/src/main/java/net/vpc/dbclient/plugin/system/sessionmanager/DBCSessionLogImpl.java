...
import net.vpc.dbclient.api.sessionmanager.DBCSessionLog;
import net.vpc.dbclient.api.viewmanager.DBCPluggablePanel;
import net.vpc.dbclient.plugin.system.SystemUtils;
import net.vpc.dbclient.plugin.system.sessionmanager.table.StyledConsoleRedirectorOutputStream;
