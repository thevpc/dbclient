...
//    }
    public void actionPerformedImpl(ActionEvent e) throws Throwable {
        ...
        splashScreen.addMessage(new SimpleSplashScreen.Message(SimpleSplashScreen.Type.INFO, msg.get("Action.CheckVersionAction.Version", new Object[]{getApplication().getApplicationInfo().getProductVersion().toString()})));
        splashScreen.addMessage(new SimpleSplashScreen.Message(SimpleSplashScreen.Type.INFO, msg.get("Action.CheckVersionAction.Checking")));
        ...
        final Timer dotsPainter = new Timer(500, new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                dots.append(".");
                MessageSet msg = getApplication().getView().getMessageSet();
                splashScreen.setMessageAt(1, new SimpleSplashScreen.Message(SimpleSplashScreen.Type.INFO, msg.get("Action.CheckVersionAction.Checking") + dots));
            }
        });
...
//                splashScreen.setBorder(BorderFactory.createEtchedBorder());
                ...
                try {
                    ...
                    splashScreen.addMessage(new SimpleSplashScreen.Message(SimpleSplashScreen.Type.INFO, msg.get("Action.CheckVersionAction.DeployedVersion", new Object[]{latestVersion})));
                    ...
                    if (latestVersion != null && !latestVersion.isEmpty() && versionComparaison == 0) {
                        splashScreen.addMessage(new SimpleSplashScreen.Message(SimpleSplashScreen.Type.INFO, msg.get("Action.CheckVersionAction.NoNewVersion", new Object[]{getApplication().getApplicationInfo().getProductVersion().toString()})));
//                        panel.setBorder(BorderFactory.createEtchedBorder());
                    } else if (latestVersion != null && !latestVersion.isEmpty() && versionComparaison > 0) {
                        splashScreen.addMessage(new SimpleSplashScreen.Message(SimpleSplashScreen.Type.ERROR, msg.get("Action.CheckVersionAction.OldVersionAvailable", new Object[]{getApplication().getApplicationInfo().getProductVersion().toString(), latestVersion})));
                    } else {
                        splashScreen.addMessage(new SimpleSplashScreen.Message(SimpleSplashScreen.Type.SUCCESS, msg.get("Action.CheckVersionAction.NewVersionAvailable", new Object[]{latestVersion, getApplication().getApplicationInfo().getProductVersion().toString()})));
//                        panel.setBorder(BorderFactory.createLineBorder(Color.GREEN, 2));
                    ...
                    splashScreen.addMessage(new SimpleSplashScreen.Message(SimpleSplashScreen.Type.ERROR, msg.get("Action.CheckVersionAction.UnknownHostException", new Object[]{e.getMessage()})));
//                    panel.setBorder(BorderFactory.createLineBorder(Color.RED, 2));
                    ...
                    splashScreen.addMessage(new SimpleSplashScreen.Message(SimpleSplashScreen.Type.ERROR, msg.get("Action.CheckVersionAction.FileNotFoundException", new Object[]{e.getMessage()})));
                } catch (IOException e) {
                    getApplication().getLogger(DBCCheckVersionAction.class.getName()).log(Level.SEVERE, "I/O error", e);
                    splashScreen.addMessage(new SimpleSplashScreen.Message(SimpleSplashScreen.Type.ERROR, msg.get("Action.CheckVersionAction.IOException", new Object[]{e.getMessage()})));
//                    panel.setBorder(BorderFactory.createLineBorder(Color.RED, 2));
                }
                dotsPainter.stop();
            }
