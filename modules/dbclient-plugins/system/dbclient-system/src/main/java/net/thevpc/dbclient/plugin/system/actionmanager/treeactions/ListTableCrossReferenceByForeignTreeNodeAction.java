...
public class ListTableCrossReferenceByForeignTreeNodeAction extends DBCTreeNodeAction {

    public ListTableCrossReferenceByForeignTreeNodeAction() {
        super("Action.ListTableCrossReferenceByForeignTreeNodeAction");
    ...
    public void actionPerformedImpl(ActionEvent e) throws Throwable {
        ...
        table.setRefreshAction(new DBCResultTableAction("Refresh", getPluginSession()) {
            ...
            public void actionPerformedImpl(ActionEvent e) throws Throwable {
                ...
                model.displayQuery(getSession().getConnection().getMetaData().getCrossReference(
                        null, null, null,
                        cp.getCatalogName(),
                        cp.getSchemaName(),
                        cp.getTableName()
