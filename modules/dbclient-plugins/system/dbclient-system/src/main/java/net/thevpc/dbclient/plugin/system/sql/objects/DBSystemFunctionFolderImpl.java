...
import net.thevpc.dbclient.api.sql.objects.DBSystemFunctionFolder;
 ...
 */
public class DBSystemFunctionFolderImpl extends DBAbstractFunctionFolderImpl implements DBSystemFunctionFolder {
    public void init(DBCConnection session) {
        super.init(session, "SystemFunctions");
    }

    protected void loadChildren() throws SQLException {
        DBFunction[] fcts = getConnection().getSystemFunctions();
