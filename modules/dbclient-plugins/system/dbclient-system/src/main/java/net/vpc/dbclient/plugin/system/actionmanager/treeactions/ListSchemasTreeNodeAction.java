...
public class ListSchemasTreeNodeAction extends DBCTreeNodeAction {

    public ListSchemasTreeNodeAction() {
        super("Action.ListSchemasTreeNodeAction");
    ...
    public void actionPerformedImpl(ActionEvent e) throws Throwable {
        ...
        table.setRefreshAction(new DBCResultTableAction("Refresh", getPluginSession()) {
            ...
            public void actionPerformedImpl(ActionEvent e) throws Throwable {
                ...
                model.setTitle("Schemas");
                model.displayQuery(getSession().getConnection().getMetaData().getSchemas(), null);
            }
        });
        table.refresh();
