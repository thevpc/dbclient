...
import net.thevpc.dbclient.api.sql.objects.DBStringFunctionFolder;
 ...
 */
public class DBStringFunctionFolderImpl extends DBAbstractFunctionFolderImpl implements DBStringFunctionFolder {
    public void init(DBCConnection session) {
        super.init(session, "StringFunctions");
    }

    protected void loadChildren() throws SQLException {
        DBFunction[] fcts = getConnection().getStringFunctions();
