 ...
 * @creationtime 28 juil. 2006 19:43:09
 */
public class OperatorResolver extends EnumeratedTokenResolver {
    public OperatorResolver() {
        super(SQLTokenGroup.OPERATOR, SQLUtils.DEFAULT_OPERATORS);
    }
}
