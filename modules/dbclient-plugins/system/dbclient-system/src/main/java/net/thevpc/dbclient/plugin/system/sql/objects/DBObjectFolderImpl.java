...
import net.thevpc.dbclient.api.sql.objects.DBObjectFolder;
import net.thevpc.dbclient.api.sql.objects.DefaultDBObject;
import net.thevpc.dbclient.api.sql.objects.SQLObjectTypes;

public abstract class DBObjectFolderImpl extends DefaultDBObject implements DBObjectFolder {
    public DBObjectFolderImpl() {
    }
