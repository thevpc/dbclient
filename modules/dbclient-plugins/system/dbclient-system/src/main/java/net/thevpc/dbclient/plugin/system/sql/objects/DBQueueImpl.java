...
import net.thevpc.dbclient.api.sql.objects.DBQueue;
 ...
 */
public class DBQueueImpl extends DefaultDBObject implements DBQueue {
    public void init(DBCConnection session, ResultSet rs) throws SQLException {
        super.init(session, "Tree.Queue", rs.getString(1), rs.getString(2), null, rs.getString(3), false);
    }


    public SQLObjectTypes getType() {
        return SQLObjectTypes.QUEUE;
    }
