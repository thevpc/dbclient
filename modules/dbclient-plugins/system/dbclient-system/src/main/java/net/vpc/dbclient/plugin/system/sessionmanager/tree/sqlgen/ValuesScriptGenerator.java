package net.vpc.dbclient.plugin.system.sessionmanager.tree.sqlgen;
...
// */
//
//package net.vpc.dbclient.sessionmanager.window.tree.sqlgen;
//
//import net.vpc.dbclient.api.sessionmanager.DBCSession;
//import net.vpc.dbclient.api.sql.SQLRecord;
//import net.vpc.dbclient.api.sql.objects.DBObject;
//import net.vpc.dbclient.api.sql.objects.Table;
//import net.vpc.dbclient.api.sql.objects.TableColumn;
//import net.vpc.dbclient.api.sql.objects.TableFolder;
