 ...
 */
public abstract class DBAbstractFunctionFolderImpl extends DBObjectFolderImpl {
    public void init(DBCConnection session, String name) {
        super.init(session, "Tree." + name, null, null, null, name, false);
    }

    protected void addFunction(DBFunction s) {
        super.addChild(s);
    }

    void addFunctionFolder(DBAbstractFunctionFolderImpl s) {
        super.addChild(s);
    }
