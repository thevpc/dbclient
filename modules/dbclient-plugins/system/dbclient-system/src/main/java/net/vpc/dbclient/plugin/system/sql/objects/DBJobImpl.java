...
import net.vpc.dbclient.api.sql.objects.DBJob;
 ...
 */
public class DBJobImpl extends DefaultDBObject implements DBJob {
    public void init(DBCConnection session, ResultSet rs) throws SQLException {
        super.init(session, "Tree.Job", rs.getString(1), rs.getString(2), null, rs.getString(3), false);
    }


    public SQLObjectTypes getType() {
        return SQLObjectTypes.JOB;
    }
