...
public class ListTableImportedKeysTreeNodeAction extends DBCTreeNodeAction {

    public ListTableImportedKeysTreeNodeAction() {
        super("Action.ListTableImportedKeysTreeNodeAction");
    ...
    public void actionPerformedImpl(ActionEvent e) throws Throwable {
        ...
        table.setRefreshAction(new DBCResultTableAction("Refresh", getPluginSession()) {
            ...
            public void actionPerformedImpl(ActionEvent e) throws Throwable {
                ...
                model.displayQuery(getSession().getConnection().getMetaData().getImportedKeys(
                        cp.getCatalogName(),
                        cp.getSchemaName(),
                        cp.getTableName()
                ), null);
