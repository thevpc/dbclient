...
//        fireTableChanged(null);
    ...
    public void displayError(String message) throws SQLException {
        ...
        displayMessage("Error", "<html><Font color=red><B>" + StringUtils.textToHtml(message) + "</B></Font></Html>");
    }

    public void displayError(SQLException message) throws SQLException {
        logger.log(Level.SEVERE, "Query failed", message);
        displayMessage("Error", "<html><Font color=red><B>" + StringUtils.textToHtml(message.getMessage()) + "</B></Font></Html>");
        throw message;
    }
