...
import net.thevpc.dbclient.api.sql.objects.DBNumberFunctionFolder;
 ...
 */
public class DBNumberFunctionFolderImpl extends DBAbstractFunctionFolderImpl implements DBNumberFunctionFolder {
    public void init(DBCConnection session) {
        super.init(session, "NumberFunctions");
    }

    @Override
    protected void loadChildren() throws SQLException {
        DBFunction[] fcts = getConnection().getNumericFunctions();
