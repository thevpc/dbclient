 ...
 */
public class SQLSchemaWordTokenResolver implements WordTokenResolver {
    private static TokenRichType SCHEMA = TokenRichType.valueOf(SQLTokenGroup.SCHEMA);

    public SQLSchemaWordTokenResolver() {
    }
