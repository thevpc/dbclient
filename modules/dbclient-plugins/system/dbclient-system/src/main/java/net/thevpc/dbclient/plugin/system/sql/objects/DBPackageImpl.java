...
import net.thevpc.dbclient.api.sql.objects.DBPackage;
 ...
 */
public class DBPackageImpl extends DefaultDBObject implements DBPackage {
    public void init(DBCConnection session, ResultSet rs) throws SQLException {
        super.init(session, "Tree.Package", rs.getString(1), rs.getString(2), null, rs.getString(3), false);
    }


    public SQLObjectTypes getType() {
        return SQLObjectTypes.PACKAGE;
    }
