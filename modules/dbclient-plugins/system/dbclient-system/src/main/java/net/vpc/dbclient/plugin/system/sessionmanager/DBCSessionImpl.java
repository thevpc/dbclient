...
import net.vpc.dbclient.api.DBCSessionTaskManager;
import net.vpc.dbclient.api.pluginmanager.DBCPlugin;
import net.vpc.log.SimpleLogFormatter;
import net.vpc.prs.factory.ImplementationFactoryDescriptor;
...
//    }
    ...
    public ClassPath getClassPath() {
        ...
        for (net.vpc.dbclient.api.pluginmanager.DBCPlugin dbcPlugin : app.getPluginManager().getEnabledPlugins()) {
