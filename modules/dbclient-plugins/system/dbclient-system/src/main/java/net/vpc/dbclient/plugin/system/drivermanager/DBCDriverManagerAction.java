 ...
 */
public class DBCDriverManagerAction extends DBCApplicationAction {
    public DBCDriverManagerAction() {
        super("Action.DriverManagerAction");
        addLocationPath(DBCActionLocation.MENUBAR, "/options");
        setPosition(Integer.MIN_VALUE + 20);
    }
...
//    }
    ...
    public void actionPerformedImpl(ActionEvent e) throws Throwable {
        getApplication().getView().getWindowManager().getDriverManagerWindow().showWindow();
    }
