...
import net.thevpc.dbclient.plugin.system.sessionmanager.window.DBCAutoCommitLabel;
import net.thevpc.dbclient.plugin.system.sessionmanager.window.DBCHoldabilityLabel;
import net.thevpc.dbclient.plugin.system.sessionmanager.window.DBCReadWriteLabel;
import net.thevpc.common.swing.dialog.MessageDialogType;

import javax.swing.*;
import java.awt.*;
import net.thevpc.dbclient.plugin.system.sessionmanager.window.DBCCatalogLabel;
