 ...
 * @creationtime 4 mai 2007 23:39:46
 */
public class DBCSessionSQLInsertFolder extends DBCSessionFolderAction {
    public DBCSessionSQLInsertFolder() {
        super("Tree.Menu.InsertSQL", "SQLInsert");
