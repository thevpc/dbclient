 ...
 * ====================================================================
 */
package net.vpc.dbclient.plugin.system;
...
import net.vpc.dbclient.api.pluginmanager.DBCPluggableResourcesSupport;
import net.vpc.swingext.PRSManager;
import net.vpc.prs.artset.ArtSet;
import net.vpc.prs.artset.NotArtSet;
 ...
 */
@PluginInfo(
        iconSet = "net.vpc.dbclient.plugin.system.viewmanager.iconset.dbclient-iconset-default"
)
public class DBCDefaultSystemPlugin extends DBCAbstractPlugin {
     ...
     *  getApplication().getView().getMessageSet().addBundle(new MessageSetResourceBundleWrapper("net.vpc.dbclient.plugin.system.viewmanager.messageset.DBClient", getApplication().getLocale(),getClass().getClassLoader()));
     * </pre>
     */
    @Override
    public void applicationInitializing() {
        ...
        getApplication().getView().getMessageSet().addBundle("net.vpc.dbclient.plugin.system.viewmanager.messageset.DBClient");
        //getApplication().setDefaultFactoryConfigurations(createFactoryConfigurations(getMessageSet()));
        IconSetManager.setClassLoaderForIconSetImports("net.vpc.dbclient.plugin.system.viewmanager.iconset.dbclient-iconset-imports", getClass().getClassLoader());
    ...
    public void pluginInstalled() {
        try {
            ...
            URL resource = getClass().getClassLoader().getResource("net/vpc/dbclient/plugin/system/configmanager/install-defaults.xml");
