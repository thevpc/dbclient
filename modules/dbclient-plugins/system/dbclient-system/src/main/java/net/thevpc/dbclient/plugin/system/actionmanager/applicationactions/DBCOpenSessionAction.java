 ...
 */
public class DBCOpenSessionAction extends DBCApplicationAction {
    public DBCOpenSessionAction() {
        super("Action.OpenSessionAction");
    ...
    public void actionPerformedImpl(ActionEvent e) throws Throwable {
        getApplication().getView().getWindowManager().getSessionListWindow().showWindow();
    }
}
