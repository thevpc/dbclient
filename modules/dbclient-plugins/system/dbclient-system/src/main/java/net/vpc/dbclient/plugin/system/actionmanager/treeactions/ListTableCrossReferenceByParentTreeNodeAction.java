...
public class ListTableCrossReferenceByParentTreeNodeAction extends DBCTreeNodeAction {

    public ListTableCrossReferenceByParentTreeNodeAction() {
        super("Action.ListTableCrossReferenceByParentTreeNodeAction");
