...
import net.vpc.dbclient.api.sessionmanager.DBCResultBrowser;
import net.vpc.dbclient.api.sessionmanager.DBCResultTable;
import net.vpc.dbclient.plugin.system.sessionmanager.window.DBCSessionInternalWindowBrowserImpl;
