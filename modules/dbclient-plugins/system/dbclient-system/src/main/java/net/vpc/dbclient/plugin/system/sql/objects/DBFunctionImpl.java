 ...
 */
public class DBFunctionImpl extends DefaultDBObject implements DBFunction {

    public void init(DBCConnection session, String name) {
        super.init(session, "Tree.Function", null, null, null, name, true);
    }
    ...
    public SQLObjectTypes getType() {
        return SQLObjectTypes.FUNCTION;
    }
